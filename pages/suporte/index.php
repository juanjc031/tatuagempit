  ...
  <section class="bg-gray-50 dark:bg-gray-900">
    <nav class="relative px-4 py-4 flex justify-between items-center bg-[#14131e] !mb-0 ">
      ...
      <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
        ...
        <li><a class="text-sm text-blue-600 font-bold" href="/TatuagemApi/pages/suporte/index.php">Suporte</a></li>
        <li class="text-gray-300">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
          </svg>
    ...
    <div class="h-full flex justify-center items-center bg-gray-900 mt-10">
      <!-- COMPONENT CODE -->
      <div class="h-full container w-3/4 mx-auto px-4 lg:px-20">
        <div class="w-full p-8 my-4 mr-auto rounded-2xl shadow-2xl bg-gray-800">
          ...
          <form id='form' action="https://formsubmit.co/grupo7pit@gmail.com" method="POST" encType='multipart/form-data'>
